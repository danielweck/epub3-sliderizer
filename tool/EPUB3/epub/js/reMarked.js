// FORK:
// https://github.com/danielweck/reMarked.js
...
if (!libObj || preserve || forcePreserve)
{
    ...
    if (preserve && libObj instanceof lib.tinl)
    {
        name = "tinl";
    }
    else if (unsup.inline.test(name))
    {
    ...
    else if (preserve && libObj instanceof lib.tblk)
    {
        name = "tblk";
    }
