...
aceEditor.commands.addCommand({
            name: "hr",
            bindKey: keyStrokes.hr,
            exec: function(editor)
            {
                var state = new TextareaState(aceEditor);
                ...
                var noCleanup = commandManager.doHorizontalRule(chunks, fixupInputArea);
...
aceEditor.commands.addCommand({
            ...
            exec: function(editor)
            {
                ...
                var noCleanup = commandManager.doCode(chunks, fixupInputArea);
...
aceEditor.commands.addCommand({
            ...
            exec: function(editor)
            {
                ...
                var noCleanup = commandManager.doHeading(chunks, fixupInputArea);
...
aceEditor.commands.addCommand({
            ...
            exec: function(editor)
            {
                ...
                var noCleanup = commandManager.doList(chunks, fixupInputArea, false);
        ...
        aceEditor.commands.addCommand({
                    ...
                    exec: function(editor)
                    {
                        ...
                        var noCleanup = commandManager.doList(chunks, fixupInputArea, true);
        ...
        aceEditor.commands.addCommand({
                    ...
                    exec: function(editor)
                    {
                        ...
                        var noCleanup = commandManager.doBlockquote(chunks, fixupInputArea);
...
aceEditor.commands.addCommand({
            ...
            exec: function(editor)
            {
                ...
                var noCleanup = commandManager.doBold(chunks, fixupInputArea);
        ...
        aceEditor.commands.addCommand({
                    ...
                    exec: function(editor)
                    {
                        ...
                        var noCleanup = commandManager.doItalic(chunks, fixupInputArea);
    ...
    function TextareaState(aceEditor, isInitialState) {

        // Aliases
        var stateObj = this;
        var inputArea = aceEditor; //panels.input;
